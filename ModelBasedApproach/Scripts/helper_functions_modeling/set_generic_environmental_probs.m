function env = set_generic_environmental_probs(disps, r_inc, dp)
...
% p_sig -- sigma for disparity probability dist
    ...
    env_inc   = gen_normal_tuning_skew( p_mu - (delta/2) , p_sig, LPNORM , k, disps );  
    env_dec   = gen_normal_tuning_skew( p_mu + (delta/2) , p_sig, LPNORM , -k, disps ); 
