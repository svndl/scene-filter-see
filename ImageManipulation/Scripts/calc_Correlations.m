%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function calc_Correlations(image)
...
if isempty(strfind(image.name,'ut_'))
    ...
    corrOrig = corr(image.imZ(~isnan(image.imZ)), imY(~isnan(image.imZ)));
    corrNew = corr(image.imZ(~isnan(image.imZ)), imYnew(~isnan(image.imZ)));
